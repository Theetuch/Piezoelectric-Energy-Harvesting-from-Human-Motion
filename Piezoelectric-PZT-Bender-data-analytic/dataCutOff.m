function [voltage, time] = dataCutOff(data)
    ...
    window_size = 4000; %assume the window size. can vary until it cover full pulse
 %ตอนแรกเป็น window/5
    start_index1 = peak1_loc - window_size/8;
    start_index2 = peak2_loc - window_size/8;
    start_index3 = peak3_loc - window_size/8;
